export const dict = {
  ...
  "prompt.placeholder.normal": 'Search person, cedula, RUC... "{{example}}"',
  "prompt.placeholder.simple": "Search person, cedula, RUC...",
  ...
  "prompt.example.1": "Look up cedula 0950804518",
  "prompt.example.2": "Who is Juan Pérez Pérez?",
  "prompt.example.3": "Generate a PDF report for cedula 0950804518",
  "prompt.example.4": "Employment history of cedula 0950804518",
  "prompt.example.5": "Direct relatives of cedula 0950804518",
  "prompt.example.6": "Last registered address for cedula 0950804518",
  "prompt.example.7": "Verify whether a cedula is active",
  "prompt.example.8": "RUC details for 0991234567001",
  "prompt.example.9": "Vehicles registered to cedula 0950804518",
  "prompt.example.10": "Phones and emails for cedula 0950804518",
  "prompt.example.11": "Salary progression for cedula 0950804518",
  "prompt.example.12": "Current employer of Juan Pérez",
  "prompt.example.13": "Judicial records by cedula",
  "prompt.example.14": "Owner of license plate PBX-1234",
  "prompt.example.15": "Main economic activity of a RUC",
  "prompt.example.16": "One-page executive summary of a person",
  "prompt.example.17": "How many jobs has cedula 0950804518 held?",
  "prompt.example.18": "Latest salary reported to IESS",
  "prompt.example.19": "Marital status and immediate family",
  "prompt.example.20": "Address history with dates",
  "prompt.example.21": "Full investigation report — every module",
  "prompt.example.22": "Registered children of cedula 0950804518",
  "prompt.example.23": "Search people named \"María González\"",
  "prompt.example.24": "Validate that a cedula is real",
  "prompt.example.25": "Compare two cedulas: kinship, address, employer",
  ...
  "session.files.delete.button": "Delete file",
  "session.files.delete.confirm": 'Delete "{{name}}" from disk? This action cannot be undone.',
  ...
  "session.new.title": "Investigate anyone",
