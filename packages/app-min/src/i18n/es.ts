export const dict = {
  ...
  "prompt.placeholder.normal": 'Buscar persona, cédula, RUC... "{{example}}"',
  "prompt.placeholder.simple": "Buscar persona, cédula, RUC...",
  ...
  "prompt.example.1": "Buscar cédula 0950804518",
  "prompt.example.2": "¿Quién es Juan Pérez Pérez?",
  "prompt.example.3": "Generar informe PDF de la cédula 0950804518",
  "prompt.example.4": "Historial laboral de la cédula 0950804518",
  "prompt.example.5": "Familiares directos de la cédula 0950804518",
  "prompt.example.6": "Última dirección registrada de la cédula 0950804518",
  "prompt.example.7": "Verificar si una cédula está activa",
  "prompt.example.8": "Datos del RUC 0991234567001",
  "prompt.example.9": "Vehículos a nombre de la cédula 0950804518",
  "prompt.example.10": "Teléfonos y correos de la cédula 0950804518",
  "prompt.example.11": "Progresión salarial de la cédula 0950804518",
  "prompt.example.12": "Empleador actual de Juan Pérez",
  "prompt.example.13": "Antecedentes judiciales por cédula",
  "prompt.example.14": "Propietario de la placa PBX-1234",
  "prompt.example.15": "Actividad económica principal de un RUC",
  "prompt.example.16": "Resumen ejecutivo en una página de una persona",
  "prompt.example.17": "¿Cuántos empleos ha tenido la cédula 0950804518?",
  "prompt.example.18": "Último salario reportado al IESS",
  "prompt.example.19": "Estado civil y núcleo familiar",
  "prompt.example.20": "Historial de direcciones con fechas",
  "prompt.example.21": "Informe de investigación completo — todos los módulos",
  "prompt.example.22": "Hijos registrados de la cédula 0950804518",
  "prompt.example.23": "Buscar personas con el nombre «María González»",
  "prompt.example.24": "Validar que una cédula es real",
  "prompt.example.25": "Comparar dos cédulas: parentesco, domicilio, empleador",
  ...
  "session.new.title": "Investiga a quien quieras",
